...
public class GenerationRandomMonstres {
    ...
    public void generermonstre(Chrono chrono, int TailleCarre, ListeMonstresVivants liste_monstres, int debut,
        ...
        if (lvl == 1) {
            if (debut == 0) {
                Serpent serpent = new Serpent(30, 2, 2, 0, TailleCarre*2);
                liste_monstres.ajouterEnFin(serpent);
                Monstres zombie = new Zombie(60, 1, 3, 0, TailleCarre * 2);
                liste_monstres.ajouterEnFin(zombie);
            }

            if (chrono.min < 5) {
                if (temps % (19500 / niveau) == 0) {
                    Monstres zombie1 = new Zombie(60, 1, 3, 0, TailleCarre * 2); // Attention: la vitess peut que être
                    liste_monstres.ajouterEnFin(zombie1); // = à 1; 2; 4; 8; 16; 0.5; 0.25
                }
                if (temps % (39500 / niveau) == 0) {
                    Monstres serpent1 = new Serpent(30, 2, 2, 0, TailleCarre * 2);
                    liste_monstres.ajouterEnFin(serpent1);
                }
            }
            if (chrono.min < 4) {
                if (temps % (26000 / niveau) == 0) {
                    Monstres zombie1 = new Zombie(60, 1, 3, 0, TailleCarre * 2);
                ...
                if (temps % (70000 / niveau) == 0) {
                    Monstres goleme1 = new Goleme(150, 1, 1, 0, TailleCarre * 2);
        ...
        if (lvl == 2) {
            if (debut == 0) {
                Monstres momie = new Momie(60, 1, 5, 0, TailleCarre * 2);
                liste_monstres.ajouterEnFin(momie);
            }

            if (chrono.min < 5) {
                if (temps % (22000 / niveau) == 0) {
                    Monstres momie1 = new Momie(60, 1, 3, 0, TailleCarre * 2);
                    liste_monstres.ajouterEnFin(momie1);
                }
                if (temps % (41000 / niveau) == 0) {
                    Monstres cobra1 = new Cobra(30, 2, 2, 0, TailleCarre * 2);
            ...
            if (chrono.min < 4) {
                ...
                if (temps % (72000 / niveau) == 0) {
                    Monstres islamiste1 = new Aladin(150, 1, 1, 0, TailleCarre * 2);
    ...
    public void genererbebe(int TailleCarre, ListeMonstresVivants liste_monstres, int x, int y, int lvl) {
        ...
        if (lvl == 1) {
            Monstres bebe1 = new Bebe(15, 2, 1, x, y);
            if (x != 17 * TailleCarre && y != 8 * TailleCarre) {
                liste_monstres.ajouterEnFin(bebe1);
            }

            if (y == TailleCarre * 2) {
                Monstres bebe2 = new Bebe(15, 2, 1, x - 10, y);
                liste_monstres.ajouterEnFin(bebe2);
                Monstres bebe3 = new Bebe(15, 2, 1, x - 20, y);
                liste_monstres.ajouterEnFin(bebe3);
            } else if (x == TailleCarre * 32) {
                if (y < 4 * TailleCarre) {
                    Monstres bebe2 = new Bebe(15, 2, 1, x - 10, 2 * TailleCarre);
                    liste_monstres.ajouterEnFin(bebe2);
                    Monstres bebe3 = new Bebe(15, 2, 1, x - 20, 2 * TailleCarre);
                    liste_monstres.ajouterEnFin(bebe3);
                } else {
                    Monstres bebe2 = new Bebe(15, 2, 1, x, y - 10);
                    liste_monstres.ajouterEnFin(bebe2);
                    Monstres bebe3 = new Bebe(15, 2, 1, x, y - 20);
                    liste_monstres.ajouterEnFin(bebe3);
                }
            } else if (y == 14 * TailleCarre) {
                if (x > 31 * TailleCarre) {
                    Monstres bebe2 = new Bebe(15, 2, 1, 32 * TailleCarre, y - 10);
                    liste_monstres.ajouterEnFin(bebe2);
                    Monstres bebe3 = new Bebe(15, 2, 1, 32 * TailleCarre, y - 20);
                    liste_monstres.ajouterEnFin(bebe3);
                } else {
                    Monstres bebe2 = new Bebe(15, 2, 1, x + 10, y);
                    liste_monstres.ajouterEnFin(bebe2);
            ...
            // else if (x == 17*TailleCarre){ // impolssible de faire apparaitre des
            // monstres sur les deux dernieres lignes droites du chemin, mystère absolu
            // if (y > 13*TailleCarre){
        ...
        if (lvl == 2) {
            Monstres bombe1 = new Bombe(15, 2, 1, x, y);
            liste_monstres.ajouterEnFin(bombe1);

            if (y == TailleCarre * 2) {
                Monstres bombe2 = new Bombe(15, 2, 1, x - 10, y);
                liste_monstres.ajouterEnFin(bombe2);
                Monstres bombe3 = new Bombe(15, 2, 1, x - 20, y);
                liste_monstres.ajouterEnFin(bombe3);
            }

            else if (x == TailleCarre * 15) {
                if (y < 4 * TailleCarre) {
                    Monstres bombe2 = new Bombe(15, 2, 1, x - 10, 2 * TailleCarre);
                    liste_monstres.ajouterEnFin(bombe2);
                    Monstres bombe3 = new Bombe(15, 2, 1, x - 20, 2 * TailleCarre);
                    liste_monstres.ajouterEnFin(bombe3);
                } else {
                    Monstres bombe2 = new Bombe(15, 2, 1, x, y - 10);
                    liste_monstres.ajouterEnFin(bombe2);
                    Monstres bombe3 = new Bombe(15, 2, 1, x, y - 20);
                    liste_monstres.ajouterEnFin(bombe3);
                }
            }
                ...
                if (x < 17 * TailleCarre) {
                    Monstres bombe2 = new Bombe(15, 2, 1, 15 * TailleCarre, y - 10);
                    liste_monstres.ajouterEnFin(bombe2);
                    Monstres bombe3 = new Bombe(15, 2, 1, 15 * TailleCarre, y - 20);
                    liste_monstres.ajouterEnFin(bombe3);
                } else {
                    Monstres bombe2 = new Bombe(15, 2, 1, x - 10, y);
                    liste_monstres.ajouterEnFin(bombe2);
