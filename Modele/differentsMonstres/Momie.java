...
public class Momie extends Monstres{
    ...
    public void GetImage(){
        try{
            ...
            haut2 = ImageIO.read(getClass().getResourceAsStream("../../images/personnages/momie_haut2.png"));
            gauche1 = ImageIO.read(getClass().getResourceAsStream("../../images/personnages/momie_gauche1.png"));
